  ...
  7: {
    onScrollDownToStep: ({ svg, x, yCategories, lineCategories, data1919MzStd }) => {
      ...
      svg.append('image')
        ...
        .attr('width', 100)
        .attr('height', 60)
        .attr('href', 'assets/2.2 Kompletni priciny umrti/Valecne akce - sipka Heydrichiada.svg')
        .attr('opacity', 0)
        .transition()
        .duration(700)
        .attr('opacity', 1)
      ...
      svg.append('image')
        ...
        .attr('width', 129)
        .attr('height', 63)
        .attr('href', 'assets/2.2 Kompletni priciny umrti/Valecne akce - sipka Osvobozovaci boje.svg')
        .attr('opacity', 0)
        .transition()
        .duration(700)
        .attr('opacity', 1)
